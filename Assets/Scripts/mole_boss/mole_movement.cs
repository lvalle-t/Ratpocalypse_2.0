...
public class mole_movement : MonoBehaviour
{
    ...
    public void SpawnAnts()
    {
        ...
        {
            Instantiate(antPrefab[Random.Range(0, antPrefab.Length)], new Vector3(Random.Range(-7, 7), Random.Range(-4, 4), 0), Quaternion.identity);
        }
    ...
    public void SpawnBats()
    {
        ...
        for (int i = 0; i < enemiesThisRow; i++)
        {
            Instantiate(batPrefab[Random.Range(0, batPrefab.Length)], new Vector3(Random.Range(-7, 7), Random.Range(-4, 4), 0), Quaternion.identity);
        }
